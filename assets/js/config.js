...
(function () {
  ...
  function apply() {
    ...
    if (fp) fp.textContent = "StudentBnB está dedicado al alojamiento estudiantil de media y larga estancia: meses, semestres o curso académico. No está pensado para estancias turísticas cortas.";
